...
function AddProduct() {
    ...
    const submitNewShoe = async () => {
        ...
        try {
            const response = await axios.post(`http://localhost:5000/api/shoe`, payload);
            console.log('Shoe data submitted:', response);
    ...
    return (
        <div>
            ...
            <Container><h1 className="title-shadow">Add a New Shoe</h1></Container>
            ...
            <Container>
                ...
                <Button variant="primary" onClick={() => submitNewShoe()} className='btn--orange'>
                        Submit
                    </Button>
